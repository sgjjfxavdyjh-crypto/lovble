-- Insert sample billboard data
INSERT INTO billboards (
  ID, Billboard_Name, City, District, Size, Status, Price, Level, 
...
(1, 'لوحة الكورنيش الرئيسية', 'الرياض', 'الملز', '4x6', 'متاح', '5000', 'A', 
...
(2, 'لوحة شارع التحلية', 'الرياض', 'العليا', '3x5', 'مؤجر', '4000', 'B',
...
(3, 'لوحة طريق الملك فهد', 'الرياض', 'السليمانية', '5x8', 'مؤجر', '7500', 'A',
...
(4, 'لوحة الطريق الدائري الشرقي', 'الرياض', 'الربوة', '4x7', 'متاح', '6000', 'A',
...
(5, 'لوحة شارع العروبة', 'الرياض', 'النخيل', '3x4', 'مؤجر', '3500', 'B',
